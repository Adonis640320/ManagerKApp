...
public class NumberPicker extends View {
	...
	private static final float DEFAULT_FLAG_TEXT_SIZE = 16;
...
//	private Sound mSound;
	...
	private void readAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mTextColor = a.getColor(R.styleable.NumberPicker_textColor1, DEFAULT_TEXT_COLOR);
		mTextSize = a.getDimension(R.styleable.NumberPicker_textSize1, DEFAULT_TEXT_SIZE * mDensity);
