...
public class ZeroTopPaddingTextView extends TextView {
    ...
    private static final float NORMAL_FONT_PADDING_RATIO = 0.164f; //0.328f;
    // the bold fontface has less empty space on the top
    private static final float BOLD_FONT_PADDING_RATIO = 0.104f; //0.208f;

    private static final float NORMAL_FONT_BOTTOM_PADDING_RATIO = 0.125f; //0.25f;
    // the bold fontface has less empty space on the top
    private static final float BOLD_FONT_BOTTOM_PADDING_RATIO = 0.104f; //0.208f;

    // pre-ICS (Droid Sans) has weird empty space on the bottom
    private static final float PRE_ICS_BOTTOM_PADDING_RATIO = 0.1165f; //0.233f;
